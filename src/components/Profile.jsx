...
import { API_URL, UserAPI, axiosAuthorized, capacitorHTTPClient, useAxios } from "../services/api.service";
                ...
                <div className="h-full">
                    {editMode ? (
                        <div className="h-full flex flex-col justify-between">
                            ...
                            <div className="h-full flex mb-1 mt-auto mb-[6rem]">
                                <button
                                    type="submit"
                        ...
                        <div className="h-full flex flex-col justify-between">
                            ...
                            <div className="flex mb-1 mt-auto mb-[6rem]">
                                <button
                                    type="button"
                                    className="bg-white m-1 text-orange-500 border-orange-500 border flex p-3 rounded-lg mt-6 w-full justify-center"
