    ...
    <div className="p-6">
      <div className="mb-8">
        <h1 className="font-semibold mb-3">
          {pendingTeams ? pendingTeams.length : 0} Pending Requests
        </h1>
        <Teams
          teams={pendingTeams}
          status="Pending"
      ...
      <div className="mb-8">
        <h1 className="font-semibold mb-3">
          {participatingTeams ? participatingTeams.length : 0} Participants
        </h1>
        <Teams
      ...
      <div className="mb-8">
        <h1 className="font-semibold mb-3">
          {rejectedTeams ? rejectedTeams.length : 0} Rejected Requests
        </h1>
        <Teams
          teams={rejectedTeams}
          status="Rejected"
            ...
            <>
              ...
              <div className="p-6">
                ...
                <h1 className="font-light mb-5">
                  {
                    /* 
                    Akshar - Display the group from the tournament.additionalDetails
                    */
                    // console.log("here", tournament?.additionalDetails)
